...
const (
	...
	ChannelTypeCodex          = 57
	ChannelTypeLiblib         = 58
	ChannelTypeAtlas          = 59
	ChannelTypeAtlasImage     = 60
...
var ChannelBaseURLs = []string{
	...
	"https://openapi.liblibai.cloud",            //58
	"https://api.atlascloud.ai",                 //59
	"https://api.atlascloud.ai",                 //60
}
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeAtlas:          "Atlas",
	ChannelTypeAtlasImage:     "AtlasImage",
}
