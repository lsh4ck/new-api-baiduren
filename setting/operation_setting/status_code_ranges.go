...
// retry for 1xx, 3xx, 4xx(except 400/408), 全部 5xx(含 504/524 网关/CDN 超时,触发级联到下一档渠道),
// 2xx 不重试。524/504 加入重试是为了让 Cloudflare 上游超时也能 cascade 到 backup 渠道(如 provider-g→provider-h)。
