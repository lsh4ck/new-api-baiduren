            ...
            <CommandGroup>
              {filteredOptions.map((option) => (
                <CommandItem
                  ...
                  className={cn(
                    'group/group-item items-start gap-3 rounded-lg px-3 py-3 transition-all duration-150 cursor-pointer',
                    // hover / keyboard-selected: 高对比度的渐变胶囊高亮
                    'hover:bg-gradient-to-r hover:from-indigo-500/15 hover:via-fuchsia-500/10 hover:to-orange-400/10',
                    'hover:ring-1 hover:ring-inset hover:ring-indigo-500/30',
                    'data-[selected=true]:bg-gradient-to-r data-[selected=true]:from-indigo-500/15 data-[selected=true]:via-fuchsia-500/10 data-[selected=true]:to-orange-400/10',
                    'data-[selected=true]:ring-1 data-[selected=true]:ring-inset data-[selected=true]:ring-indigo-500/30',
                    // 当前已选中（已是表单值）：粗左边线 + 浅底色提示
                    value === option.value &&
                      'border-l-[3px] border-l-indigo-500 bg-indigo-500/[0.04] dark:bg-indigo-400/[0.06]'
                  )}
                >
                  <Check
                    className={cn(
