...
import { Search, Copy, Check, ChevronLeft, ChevronRight, Trash2 } from 'lucide-react'
...
export function BillingHistoryDialog({
  ...
  const handleConfirmDelete = async () => {
    if (confirmDeleteId != null) {
      const ok = await handleDeleteOrder(confirmDeleteId)
  ...
  return (
    <>
                    ...
                    return (
                      ...
                      >
                        ...
                        {(() => {
                          ...
                          if (!canDelete && !canComplete) return null
                          return (
      ...
      {/* Confirm Delete Order Dialog (user-side) */}
      <AlertDialog
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              确认删除该订单？仅 pending / failed / expired 状态可删除，已成功支付的订单无法删除。
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
