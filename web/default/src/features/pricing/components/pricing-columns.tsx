  ...
  return [
    // Model column
    {
      ...
      cell: ({ row }) => {
        ...
        const isSmartAuto =
          model.billing_mode === 'smart_auto' || model.model_name === 'bdr-auto'
        ...
        return (
          <div className='flex min-w-[200px] items-center gap-2'>
            ...
            >
              {isSmartAuto ? t('Intelligent Auto-Select') : model.model_name}
            </span>
          </div>
        )
      },
    ...
    // Price column
    {
      ...
      cell: ({ row }) => {
        const model = row.original
        if (
          model.billing_mode === 'smart_auto' ||
          model.model_name === 'bdr-auto'
        ) {
          return (
