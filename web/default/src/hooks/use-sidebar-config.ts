...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/subscription-accounts': { section: 'admin', module: 'subscription_accounts' },
  '/subscription-groups': { section: 'admin', module: 'subscription_groups' },
  '/subscription-proxies': { section: 'admin', module: 'subscription_proxies' },
