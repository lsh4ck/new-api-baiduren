        ...
        >
          ...
          >
              ...
              {links.slice(0, 3).map((link, i) => {
                ...
                if (link.external) {
                  return (
                    <a
                      ...
                      className='text-muted-foreground hover:text-foreground rounded-lg px-2 py-1.5 text-[13px] font-medium transition-colors duration-200 whitespace-nowrap'
                    >
                      {t(link.title)}
                    </a>
                  )
                ...
                return (
                  <Link
                    ...
                    to={link.href}
                    className={cn(
                      'rounded-lg px-2 py-1.5 text-[13px] font-medium transition-colors duration-200 whitespace-nowrap',
                      isActive
                        ? 'text-foreground'
            ...
            <div className='flex items-center gap-2 sm:hidden'>
              {showThemeSwitch && <ThemeSwitch />}
              {showAuthButtons && !loading && isAuthenticated && <ProfileDropdown />}
              <Button
                type='button'
                variant='ghost'
                size='icon'
        ...
        <div className='flex h-full flex-col justify-between px-8 pt-20 pb-10'>
          ...
          >
            {showAuthButtons && (
              ...
              >
                {isAuthenticated ? t('Go to Console') : t('Sign in')}
              </Link>
            )}
          </div>
        </div>
